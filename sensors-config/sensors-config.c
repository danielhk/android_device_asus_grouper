 ...
 * (but not all), and some bad design (but not all). This way if ever come
...
static uid_t uid_system = 1000; //in case we cannot get this info, this is a backup
static gid_t gid_system = 1000; //in case we cannot get this info, this is a backup
